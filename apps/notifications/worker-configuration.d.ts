/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: f1b4bb0edebbcc3b75b9c5fd9261728c)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		MARK_DONE: true;
		MAX_PAGES: 2;
		GITHUB_NOTIFICATIONS_TOKEN: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MARK_DONE" | "MAX_PAGES" | "GITHUB_NOTIFICATIONS_TOKEN" | "GITHUB_REPO_TOKEN">> {}
}
