/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 38a51b7d9252aa6a4390e464637b4639)
// Runtime types generated with workerd@1.20260918.1 2026-04-22 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	AI: Ai;
	DEFAULT_MODEL: "@cf/ibm-granite/granite-4.0-h-micro";
	HMAC_SECRET: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DEFAULT_MODEL" | "HMAC_SECRET">> {}
}
